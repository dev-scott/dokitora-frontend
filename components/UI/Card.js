  ...
  if (index == 0) {
    ...
    >
      ...
      <View className="flex flex-row flex-wrap flex-1 w-full  gap-[10px] mt-6 ">
        ...
        <Pressable onPress={()=>{navigation.navigate("HomePharmacy")}} className=" w-[130px] h-[166px] bg-white600 p-4 rounded-3xl border  border-white backdrop-blur-xl flex justify-center items-start    ">
          <View className=" flex justify-center items-center bg-green600 p-3 rounded-full ">
            <Buy />
          </View>
